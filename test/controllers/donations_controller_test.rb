...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { amount: @donation.amount, autor: @donation.autor, campaign_id: @donation.campaign_id, message: @donation.message } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { amount: @donation.amount, autor: @donation.autor, campaign_id: @donation.campaign_id, message: @donation.message } }
